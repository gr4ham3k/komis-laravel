                    ...
                    @forelse ($listing->images as $index => $image)
                        <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                            <img src="{{ asset('images/' . $image->file_name) }}" class="d-block w-100"
                                style="height: 420px; object-fit: cover;" alt="{{ $image->original_name }}">
                        </div>
                    @empty
                        <div class="carousel-item active">
                            <img src="https://via.placeholder.com/800x420?text=Brak+zdjecia" class="d-block w-100"
                                style="height: 420px; object-fit: cover;" alt="Brak zdjecia">
                        </div>
                    @endforelse
                </div>
