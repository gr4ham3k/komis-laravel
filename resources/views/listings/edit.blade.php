                    ...
                    <form method="POST" action="{{ route('listings.update', $listing) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="brand_id" id="brand-id" value="{{ old('brand_id', $listing->brand_id) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="model_id" id="model-id" value="{{ old('model_id', $listing->model_id) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="fuel_id" class="form-select @error('fuel_id') is-invalid @enderror" required>
                                    <option value="">Wybierz paliwo</option>
                                    @foreach ($fuels as $fuel)
                                        <option value="{{ $fuel->id }}" {{ old('fuel_id', $listing->fuel_id) == $fuel->id ? 'selected' : '' }}>
                                            {{ $fuel->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="transmission_id" class="form-select @error('transmission_id') is-invalid @enderror" required>
                                    ...
                                    @foreach ($transmissions as $transmission)
                                        <option value="{{ $transmission->id }}" {{ old('transmission_id', $listing->transmission_id) == $transmission->id ? 'selected' : '' }}>
                                            {{ $transmission->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="body_type_id" class="form-select @error('body_type_id') is-invalid @enderror" required>
                                    <option value="">Wybierz nadwozie</option>
                                    @foreach ($bodyTypes as $bodyType)
                                        <option value="{{ $bodyType->id }}" {{ old('body_type_id', $listing->body_type_id) == $bodyType->id ? 'selected' : '' }}>
                                            {{ $bodyType->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="hidden" name="city" id="city" value="{{ old('city', $listing->city) }}">
...
@push('scripts')
<script>
    const map = L.map('map').setView([{{ $listing->latitude ?? '50.0413' }}, {{ $listing->longitude ?? '21.9990' }}], 13);
